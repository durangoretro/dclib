...
all: $(BUILD_DIR)/durango.lib $(BUILD_DIR)/pocket.lib $(BUILD_DIR)/system.lib $(INC_DIR)/font.h $(BUILD_DIR)/qgraph.lib $(BUILD_DIR)/psv.lib $(BUILD_DIR)/sprites.lib $(BUILD_DIR)/geometrics.lib $(BUILD_DIR)/conio.lib $(BUILD_DIR)/glyph.lib $(BUILD_DIR)/music.lib $(BUILD_DIR)/pocketlib.lib
...
$(BUILD_DIR)/pocketlib.o: $(ASM_DIR)/pocketlib.s $(BUILD_DIR)
	ca65 -t none $(ASM_DIR)/pocketlib.s -o $(BUILD_DIR)/pocketlib.o
$(BUILD_DIR)/pocketlib.lib: $(BUILD_DIR)/pocketlib.o $(BUILD_DIR)
	ar65 r $(BUILD_DIR)/pocketlib.lib $(BUILD_DIR)/pocketlib.o
